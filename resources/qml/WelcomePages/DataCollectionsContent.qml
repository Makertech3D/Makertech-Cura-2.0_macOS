...
Item
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@label", "Help us to improve Makertech Cura")
    ...
    Item
    {
        ...
        Column
        {
            ...
            Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: catalog.i18nc("@text", "Makertech Cura collects anonymous data to improve print quality and user experience, including:")
            ...
            Label
            {
                ...
                text:
                {
                    var t = catalog.i18nc("@text", "Data collected by Makertech Cura will not contain any personal information.")
